...
CREATE TABLE Users(
	...
	DefaultMeals VARCHAR(100) NULL DEFAULT 'Breakfast,Lunch,Dinner',
...
CREATE TABLE MealData(
	...
	CONSTRAINT FK_MealData_Food FOREIGN KEY(FoodID) REFERENCES FoodItems(FoodID) ON DELETE SET NULL
);
...
CREATE TABLE DishData(
	...
	CONSTRAINT FK_DishData_Food FOREIGN KEY(IngredientID) REFERENCES FoodItems(FoodID) ON DELETE SET NULL
);
